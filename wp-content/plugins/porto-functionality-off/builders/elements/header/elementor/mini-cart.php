		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'raw'             => sprintf( esc_html__( 'Please see %1$sTheme Options -> Skin -> Mini Cart%2$s panel.', 'porto-functionality' ), '<b>', '</b>' ),
			...
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						...
						'#mini-cart.minicart-arrow-alt .cart-head:after' => 'color: {{VALUE}};',
					),
				)
			);
