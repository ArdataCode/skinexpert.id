				...
				array(
					...
					'params'      => array(
						array(
							...
							'text'       => esc_html__( 'Please see \'Theme Options -> General -> Logo, Icons\' panel.', 'porto-functionality' ),
						),
						$custom_class,
					),
				)
			...
			vc_map(
				array(
					...
					'params'      => array(
						...
						array(
							'type'       => 'porto_param_heading',
							'param_name' => 'description_menu_skin',
							'text'       => esc_html__( 'Please see \'Theme Options -> Skin -> Main Menu\' panel.', 'porto-functionality' ),
						),
						array(
							'type'        => 'dropdown',
			...
			vc_map(
				array(
					...
					'params'      => array(
						...
						array(
							'type'       => 'porto_param_heading',
							'param_name' => 'description_switcher_skin',
							'text'       => esc_html__( 'Please see \'Theme Options -> Skin -> Language, Currency Switcher\' panel.', 'porto-functionality' ),
						),
						array(
							'type'        => 'dropdown',
			...
			vc_map(
				array(
					...
					'params'      => array(
						...
						array(
							'type'       => 'porto_param_heading',
							'param_name' => 'description_search_skin',
							'text'       => esc_html__( 'Please see \'Theme Options -> Skin -> Search Form\' panel.', 'porto-functionality' ),
						),
						array(
							'type'       => 'textfield',
			...
			vc_map(
				array(
					...
					'params'      => array(
						array(
							'type'       => 'porto_param_heading',
							'param_name' => 'description_cart',
							'text'       => esc_html__( 'Please see \'Theme Options -> Skin -> Mini Cart\' panel.', 'porto-functionality' ),
						),
						array(
							'type'        => 'dropdown',
							'heading'     => __( 'Type', 'porto-functionality' ),
						...
						array(
							...
							'selectors'   => array(
								'#mini-cart .cart-items, #mini-cart .cart-items-text' => 'color: {{VALUE}};',
							),
				...
				array(
					...
					'params'      => array(
						array(
							...
							'text'       => esc_html__( 'Please see \'Theme Options -> Header -> Mobile Panel\'.', 'porto-functionality' ),
						),
						array(
							'type'       => 'porto_param_heading',
							'param_name' => 'description_mobile_toggle_skin',
							'text'       => esc_html__( 'Please see \'Theme Options -> Skin -> Mobile Menu\' panel.', 'porto-functionality' ),
						),
						array(
							'type'       => 'textfield',
							'heading'    => __( 'Custom Icon Class', 'porto-functionality' ),
