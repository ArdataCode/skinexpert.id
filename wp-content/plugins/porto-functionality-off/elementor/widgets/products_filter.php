	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} select' => 'background-position: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => '--porto-product-filter-select-width: {{VALUE}}%;',
				),
				'default'   => '20',
				'condition' => array(
					'set_inline' => 'yes',
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}}' => '--porto-product-filter-space: {{SIZE}}{{UNIT}};',
				),
				'default'    => array(
					'unit' => 'px',
					'size' => 10,
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => '--porto-product-filter-select-width-md: {{VALUE}}%;',
				),
				'default'   => '20',
				'condition' => array(
					'set_inline' => 'yes',
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}}' => '--porto-product-filter-space-md: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
					'set_inline' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => '--porto-product-filter-submit-width: {{VALUE}}%;',
				),
				'default'   => '20',
				'condition' => array(
					'set_inline' => 'yes',
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}}' => '--porto-product-filter-submit-width-md: {{VALUE}}%;',
				),
				'default'   => '20',
				'condition' => array(
					'set_inline' => 'yes',
