		...
		array(
			...
			'params'      => array(
				array(
					...
					'text'       => esc_html__( 'Please see Theme Options -> Breadcrumbs & Theme Options -> Skin -> Breadcrumbs.  If the type is different with theme option, it doesn\'t work well.', 'porto-functionality' ),
				),
				array(
					'type'        => 'dropdown',
