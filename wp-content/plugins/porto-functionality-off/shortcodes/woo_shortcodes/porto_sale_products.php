...
function porto_load_sale_products_shortcode() {
	...
	$product_slider_fields = porto_vc_product_slider_fields();
	$product_slider_fields[7]['value'][ __( 'Normal dot', 'porto-functionality' ) ] = 'dots-style-normal';
