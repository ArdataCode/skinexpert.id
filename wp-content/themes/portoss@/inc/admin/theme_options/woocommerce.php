	...
	$this->sections[] = array(
		...
		'fields'     => array(
			...
			array(
				...
				'desc'    => __( 'Filter all products including default pagination by Ajax in shop pages.', 'porto' ),
				'default' => false,
				'on'      => __( 'Yes', 'porto' ),
				'off'     => __( 'No', 'porto' ),
			),
			array(
				...
				'options'  => array(
					...
					'horizontal'  => array(
						'title' => __( 'Horizontal filters 1', 'porto' ),
						'img'   => PORTO_OPTIONS_URI . '/svg/shop-horizontal1.svg',
					),
					'horizontal2' => array(
						'title' => __( 'Horizontal filters 2', 'porto' ),
