...
function porto_load_shortcodes() {
	...
	if ( function_exists( 'vc_map' ) ) {
		...
		$floating_circle        = array(
			'type'        => 'checkbox',
			'heading'     => __( 'Floating Circle', 'porto' ),
		...
		vc_add_params( 'vc_btn', array( $animation_type, $animation_duration, $animation_delay, $floating_circle, $floatcircle_transition, $floatcircle_duration, $floating_start_pos, $floating_speed, $floating_transition, $floating_horizontal, $floating_duration ) );
